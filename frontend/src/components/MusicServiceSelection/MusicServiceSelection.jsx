...
export default function MusicServiceSelection({ onSpotifyUpdate, onAppleMusicUpdate }) {
    ...
    <div className="p-4">
      {!selectedService ? (
        <div className="text-center">
          <h3 className="text-lg font-medium text-gray-900 mb-6">Choose Your Music Service</h3>
